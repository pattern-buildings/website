<template>
  <Layout>
    ...
    <div class="mx-auto mt-4 mb-16 relative embedded-video">
      <iframe
    ...
    <div class="flex flex-col items-center mx-auto mt-4 mb-16">
      ...
      >
        <h2 class="text-left sm:text-right sm:w-1/2 mb-2 sm:mb-0 sm:mr-4">
          {{ feature.name }}
        </h2>
        <p
    ...
    <h2 class="text-center mt-16">Get in touch</h2>
